                    ...
                    selectedTrainTypes.some(type => info.trainNo.startsWith(type))
                       ...
                       &&
                        (
                            ...
                            || (selectedSeatTypes.includes('firstSeat') &&  (info.firstSeat === '有' || info.firstSeat === '无' || !isNaN(info.firstSeat)))
                            ...
                            || (selectedSeatTypes.includes('secondSeatAndSecondBoxSeat') &&  ((info.secondSeatAndSecondBoxSeat === '有'|| info.secondSeatAndSecondBoxSeat === '无' || !isNaN(info.secondSeatAndSecondBoxSeat))))
                            ...
                            || (selectedSeatTypes.includes('hardSleeper') &&  (info.hardSleeper !="---" || !isNaN(info.hardSleeper)))
                            ...
                            || (selectedSeatTypes.includes('hardSeat') &&  (info.hardSeat === '有' || info.hardSeat === '无'|| !isNaN(info.hardSeat)))
